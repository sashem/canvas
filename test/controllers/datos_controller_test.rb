...
class DatosControllerTest < ActionController::TestCase
  ...
  test "should create dato" do
    assert_difference('Dato.count') do
      post :create, dato: { apellido: @dato.apellido, edad: @dato.edad, mail: @dato.mail, nombre: @dato.nombre }
    end
  ...
  test "should update dato" do
    patch :update, id: @dato, dato: { apellido: @dato.apellido, edad: @dato.edad, mail: @dato.mail, nombre: @dato.nombre }
    assert_redirected_to dato_path(assigns(:dato))
  end
